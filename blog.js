...
function renderPostPage(post) {
  ...
  return '<!DOCTYPE html>\n<html lang="zh-Hant"><head>\n' +
    ...
    '<meta name="description" content="' + escapeHtml(post.title) + ' — MACARON DE LUXE 法式精品馬卡龍 / 禮贈禮盒">\n' +
    ...
    tagsHtml + '\n' +
    '</article>\n' +
    '<footer>© MACARON DE LUXE · 法式精品馬卡龍 + 高端禮贈<br>FB: <a href="https://www.facebook.com/profile.php?id=61586936279154">MACARON DE LUXE</a> · IG: <a href="https://www.instagram.com/macaron_de_luxe/">@macaron_de_luxe</a></footer>\n' +
    '</body></html>';
}
...
function renderIndexPage() {
  ...
  return '<!DOCTYPE html><html lang="zh-Hant"><head>' +
    ...
    '<div class="intro"><strong>法式精品馬卡龍 + 高端禮贈品牌</strong>。每週更新關於馬卡龍口味、禮盒搭配、婚禮企業禮贈、品牌故事等內容。<br>📲 LINE 諮詢：<a href="https://lin.ee/843cifiy">@843cifiy</a></div>' +
