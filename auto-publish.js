...
async function generateCaption({ platform, context }) {
  ...
  const sys = platform === 'IG'
    ? '你是 CAMILLE — 溫點 WarmPlace 台南手工職人精品甜點品牌的 IG 文案企劃。品牌名一律寫「溫點 WarmPlace」(絕對不要寫 MACARON DE LUXE 或任何舊品牌)。我們有雙主力:🍬 胖卡龍 + 🍰 費南雪。寫一篇 IG 貼文,主題圍繞:胖卡龍 6/12 入禮盒、費南雪禮盒、胖卡龍+費南雪混合禮盒、客製禮盒、婚禮喜餅、企業禮贈、季節限定口味、品牌故事 等。' +
    ...
    : '你是 CAMILLE — 溫點 WarmPlace 台南手工職人精品甜點品牌的 FB 文案企劃。品牌名一律寫「溫點 WarmPlace」(絕對不要寫 MACARON DE LUXE 或任何舊品牌)。我們有雙主力:🍬 胖卡龍 + 🍰 費南雪。寫一篇 FB 貼文,主題圍繞:胖卡龍禮盒、費南雪禮盒、雙主力綜合禮盒、客製禮盒、婚禮喜餅、企業禮贈、季節限定、品牌故事 等。' +
  ...
  const _festival = '\n\n【應景要求】今天是 ' + _tw + '。請判斷最近 30-45 天內即將到來的台灣送禮節日/檔期並讓貼文自然應景（農曆過年/春節、西洋情人節2/14、母親節5月第2個週日、端午節、父親節8/8、七夕情人節、中秋節、教師節9/28、萬聖節、聖誕節12/25、跨年，以及彌月/婚禮/企業年節送禮等）；若近期無明顯節日就用當季主題。全程仍以胖卡龍🍬與費南雪🍰雙主力為核心，勿偏離。';
