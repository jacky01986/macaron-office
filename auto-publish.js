...
async function generateCaption({ platform, context }) {
  ...
  const sys = platform === 'IG'
    ? '你是 CAMILLE — 溫點 WarmPlace 台南手工職人精品甜點品牌的 IG 文案企劃。品牌名一律寫「溫點 WarmPlace」(絕對不要寫 MACARON DE LUXE 或任何舊品牌)。我們有主力:🍬 胖卡龍。寫一篇 IG 貼文,主題圍繞:胖卡龍 6/12 入禮盒、胖卡龍混合禮盒、客製禮盒、婚禮喜餅、企業禮贈、季節限定口味、品牌故事 等。' +
      '風格:台南手工職人療癒、雋永、留白、像台南手工職人咖啡店文案。長度 80-120 字。最後加 5-8 個相關 hashtag (例: #溫點WarmPlace #warmplacehere #台南手工胖卡龍 #精品禮盒 #台南甜點)。用繁體中文。禁用詞:超讚/必吃/CP值/秒殺/小資/親民。禁止出現「MACARON DE LUXE」這個舊品牌名。'
    : '你是 CAMILLE — 溫點 WarmPlace 台南手工職人精品甜點品牌的 FB 文案企劃。品牌名一律寫「溫點 WarmPlace」(絕對不要寫 MACARON DE LUXE 或任何舊品牌)。我們有主力:🍬 胖卡龍。寫一篇 FB 貼文,主題圍繞:胖卡龍禮盒、主力綜合禮盒、客製禮盒、婚禮喜餅、企業禮贈、季節限定、品牌故事 等。' +
      '風格:親切、有條理、引導行動,台南手工職人療癒基調。長度 100-180 字,結尾加 1 個 CTA (例:「📩 私訊預訂」「🌹 線上訂購」)。用繁體中文。禁用詞:超讚/必吃/CP值/秒殺/小資/親民。禁止出現「MACARON DE LUXE」這個舊品牌名。';
  const _tw = new Date().toLocaleDateString('zh-TW', { timeZone: 'Asia/Taipei', year: 'numeric', month: 'long', day: 'numeric', weekday: 'long' });
  const _festival = '\n\n【應景要求】今天是 ' + _tw + '。請判斷最近 30-45 天內即將到來的台灣送禮節日/檔期並讓貼文自然應景（農曆過年/春節、西洋情人節2/14、母親節5月第2個週日、端午節、父親節8/8、七夕情人節、中秋節、教師節9/28、萬聖節、聖誕節12/25、跨年，以及彌月/婚禮/企業年節送禮等）；若近期無明顯節日就用當季主題。全程仍以胖卡龍🍬主力為核心，勿偏離。';
  const user = '請寫今天的 ' + platform + ' 貼文。' + _festival + '\n\n參考資料：\n' + JSON.stringify(context || {}).slice(0, 1500) + scoutTail();
  try {
...
const _rbTerms=[['韓系精品高端禮贈','台南在地真人手作精品禮贈'],['#韓系馬卡龍','#台南手工胖卡龍'],['#韓系','#台南手工'],['韓系','台南手工職人'],['韓式','台南手工職人'],['韓國','台南'],['馬卡龍','胖卡龍'],['🍬 胖卡龍 + 🍰 費南雪','🍬 胖卡龍'],['胖卡龍 + 費南雪','胖卡龍'],['胖卡龍+費南雪','胖卡龍'],['胖卡龍與費南雪','胖卡龍'],['與費南雪',''],['、費南雪',''],['，費南雪',''],['🍰 費南雪',''],['🍰費南雪',''],['費南雪禮盒',''],['費南雪','']];
