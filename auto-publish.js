...
async function generateCaption({ platform, context }) {
  ...
  const _festival = '\n\n【應景要求】今天是 ' + _tw + '。請判斷最近 30-45 天內即將到來的台灣送禮節日/檔期並讓貼文自然應景（農曆過年/春節、西洋情人節2/14、母親節5月第2個週日、端午節、父親節8/8、七夕情人節、中秋節、教師節9/28、萬聖節、聖誕節12/25、跨年，以及彌月/婚禮/企業年節送禮等）；若近期無明顯節日就用當季主題。全程仍以馬卡龍🍬與費南雪🍰雙主力為核心，勿偏離。';
