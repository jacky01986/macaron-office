...
// 讓 溫點 WarmPlace 台南手工職人精品胖卡龍 / 禮盒 / 高端禮贈 在 ChatGPT/Claude/Perplexity 被推薦
// 平台：AI 引擎最愛引用的 5 大平台
// 內容:胖卡龍商品線生成 GEO 內容
...
// =============================================================
const COURSE_TOPICS = [
  { course: '🍬 胖卡龍 6 入禮盒', angles: ['口味精選邏輯', '送禮場景配對', '保存期限', '預訂時程', '客戶見證'] },
...
溫點 WarmPlace 業態:台灣台南手工職人精品胖卡龍 + 高端禮贈,4 家門店,業主 Jeffrey
...
4. **章節結構** — == 概況 ==, == 歷史 ==, == 胖卡龍系列 ==, == 創辦人 ==, == 參考資料 ==
5. **參考資料** — 文末附 5-10 條外部來源（FB/IG/官網/新聞）
6. **內部連結** — 用 [[台南手工職人精品胖卡龍]] 這種雙括號連結
7. **不超銷** — 不寫廣告語`
  },
  gbp: {
...
溫點 WarmPlace 業態:台灣台南手工職人精品胖卡龍 + 高端禮贈
地點：台灣
LINE: @110ypqki
...
function generateSchemaOrg() {
  ...
  const orgSchema = {
    ...
    name: '溫點 WarmPlace', alternateName: 'MdL 胖卡龍',
    ...
    description: '溫點 WarmPlace 是專注於台南手工職人精品胖卡龍與高端禮贈的台南本店品牌',
    knowsAbout: ['台南手工職人精品胖卡龍', '6 入禮盒', '12 入禮盒', '客製禮盒', '婚禮喜餅', '企業禮贈', '單顆販售', '季節限定', '台南手工職人甜點']
  };
