...
const SERVICES = [
  { id: 'feathered_brow', name: '飄眉', search_terms: '飄眉 紋繡 課程 價格' },
  { id: 'feathered_misty_brow', name: '飄霧眉', search_terms: '飄霧眉 紋繡 課程 價錢' },
  { id: 'misty_brow', name: '霧眉', search_terms: '霧眉 紋繡 課程 教學' },
  { id: 'pigment_removal', name: '除色', search_terms: '紋繡除色 雷射除色 課程' },
  { id: 'misty_lip', name: '霧唇', search_terms: '霧唇 唇紋繡 課程 價格' },
  { id: 'lip_recolor', name: '唇改色', search_terms: '唇改色 紋唇改色 教學' },
  { id: 'smp', name: 'SMP', search_terms: 'SMP 頭皮微色素 課程 教學' },
  { id: 'hairline', name: '髮際線', search_terms: '髮際線 紋繡 紋髮際線 課程' },
];
