...
const DATA_DIR = process.env.RENDER_DISK_MOUNT_PATH || '/opt/render/project/src/macaron-office/data';
...
function renderPostPage(post) {
  ...
  return '<!DOCTYPE html>\n<html lang="zh-Hant"><head>\n' +
    ...
    '<meta name="description" content="' + escapeHtml(post.title) + ' — MACARON DE LUXE 韓式半永久紋繡 / SMP 教學">\n' +
    ...
    tagsHtml + '\n' +
    '</article>\n' +
    '<footer>© MACARON DE LUXE · 韓式半永久紋繡 + SMP 教學<br>FB: <a href="https://www.facebook.com/profile.php?id=61586936279154">MACARON DE LUXE</a> · IG: <a href="https://www.instagram.com/ofz_beauty_academy_/">@ofz_beauty_academy_</a></footer>\n' +
    '</body></html>';
}
...
function renderIndexPage() {
  ...
  return '<!DOCTYPE html><html lang="zh-Hant"><head>' +
    '<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
    '<title>MACARON DE LUXE 部落格 | 韓式半永久紋繡 SMP 教學</title>' +
    '<meta name="description" content="MACARON DE LUXE 部落格 — 韓式半永久紋繡、SMP、飄眉、霧眉、髮際線教學 + 實作技巧">' +
    ...
    '<div class="intro"><strong>韓式半永久紋繡 + SMP 教學中心</strong>。每天更新關於飄眉、飄霧眉、霧眉、髮際線、SMP、除色等技術文章與課程介紹。<br>📲 LINE 諮詢：<a href="https://lin.ee/843cifiy">@843cifiy</a></div>' +
